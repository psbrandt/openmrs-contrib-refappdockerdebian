...
docker tag `docker images -q openmrscontribrefappdockerdebian_openmrs-refapp-tomcat` psbrandt-docker-openmrs-refapp-debian.bintray.io/tomcat:$TRAVIS_TAG

# Push the tomcat image
docker push psbrandt-docker-openmrs-refapp-debian.bintray.io/tomcat:$TRAVIS_TAG

# Tag the mysql image
docker tag `docker images -q openmrscontribrefappdockerdebian_openmrs-refapp-mysql` psbrandt-docker-openmrs-refapp-debian.bintray.io/mysql:$TRAVIS_TAG
